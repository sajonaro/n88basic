# N88-BASIC(86) extension — maintainer reference

**Looking for how to use the extension? See [README.md](README.md).**
This document is for people changing it: module layout, how each feature is
built, and why.
